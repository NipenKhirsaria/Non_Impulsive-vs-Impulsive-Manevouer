...
# R is position vector in geocentric equitorial frame
# V is velocity vector in geocentric equitorial frame
...
def coe_from_sv(v_R_BII, v_V_BII):
    ...
    r_parameters = [h*(10**-10),e,RAAN*180/pi,incl*180/pi,w*180/pi,ta*180/pi,a*0.001]

    return r_parameters

v_r_1_BII,v_v_1_BII,m_1,t_burn_1 = end_of_burn_states()
r_parameters = coe_from_sv(v_r_1_BII,v_v_1_BII)
