...
def end_of_burn_states(MU, GRAV_ACC, m_0, T, Isp, v_rp_0_BII, v_vp_0_BII):
        ...
        t_burn = float(input('Enter the burn time in sec: '))
        t = np.linspace(0,t_burn)
        ...
        return v_r_1_BII,v_v_1_BII,m_1,t_burn
